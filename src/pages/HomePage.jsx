...
const HomePage = () => {
    ...
    return (
        <Page>
            ...
            <SearchBar spellCheck="false" onChange={v => setQuery(v.trim())} defaultValue={query}/>
            ...
            <HomeAssetsGrid>
            {assets.filter(e => e.type === selectedCategory || selectedCategory === "All").filter(asset => query.includes(asset.key) || query.trim() === "").map(i => <AssetCard type={i.type} key={i.type + "-" + i.key} title={i.key} link={i.link}></AssetCard>)}
